...
app.controller('ctrlGridView', function ($scope) {
    ...
    var task1 = { id: 1, name: 'Task 1', desc: 'Ovo je Task 1' };
    var task2 = { id: 2, name: 'Task 2', desc: 'Ovo je Task 2' };
    var task3 = { id: 3, name: 'Task 3', desc: 'Ovo je Task 3' };
    var task4 = { id: 4, name: 'Task 4', desc: 'Ovo je Task 4' };
    var task5 = { id: 5, name: 'Task 5', desc: 'Ovo je Task 5' };
